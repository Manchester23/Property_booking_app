    ...
    return (
        <header className="flex justify-between">
          <a href="" className="flex items-center gap-1">
            ...
            <span className="font-bold text-xl">RentalHome</span>
          </a>
          <div className="flex font-bold border gap-2 border-grey-300 rounded-full py-2 px-4 shadow-md shadow-grey-500">
            <div>Anywhere</div>
          ...
          <Link to={'/login'} className="flex items-center border gap-2 border-grey-300 rounded-full py-2 px-4">
